...
def main():
    ...
    if not os.environ.get("GITHUB_WORKFLOW"):
        ...
        if exit_code:
            ...
            return exit_code
        if {{cookiecutter.cms == "Wagtail"}}:
            exit_code = os.system("echo \"Site.objects.all().update(hostname='{{cookiecutter.domain_name}}', site_name='{{cookiecutter.project_name}}')\" | .venv/bin/python {{cookiecutter.project_slug}}/manage.py shell_plus")
        else:
